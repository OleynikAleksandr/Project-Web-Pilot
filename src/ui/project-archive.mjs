export function projectArchiveView(action) {
  ...
  function render(next, actionPending) {
    ...
    const hideToolCalls = state.hideToolCalls !== false;
    $('tool-calls-hide').setAttribute('aria-pressed', String(hideToolCalls));
    $('tool-calls-show').setAttribute('aria-pressed', String(!hideToolCalls));
