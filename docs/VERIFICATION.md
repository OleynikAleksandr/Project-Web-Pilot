...
Скриншот 20:34:54 и сообщение пользователя подтверждают вход в аккаунт, мастер показывает «Вход подтверждён». Следующее действие «Установить компонент Apple» открыло системное подтверждение под окном Web Pilot. MAC-003: скрытое внешнее подтверждение, исправление C010, проверка новой поставки T017. Полная установка и подключение инструментов пока не пройдены.
