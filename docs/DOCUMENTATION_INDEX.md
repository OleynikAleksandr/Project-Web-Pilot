...
| Документ | Назначение |
| --- | --- |
| docs/modules/first-run-onboarding.md | Путь первого запуска, итерация 0.6.34 с ограниченным первым открытием обеих платформ, macOS-мастер и ожидаемый T015, Base/клоны, границы facade и критерии полного пользовательского результата |
