...
| Документ | Назначение |
| --- | --- |
| docs/modules/first-run-onboarding.md | Согласованный путь от установки до первого рабочего проекта, подготовленный Base и свежие клоны, повторные исправления/сборки, границы facade и критерии пользовательского результата |
