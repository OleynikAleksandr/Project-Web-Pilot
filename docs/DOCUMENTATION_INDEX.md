...
| Документ | Назначение |
| --- | --- |
| docs/modules/first-run-onboarding.md | Путь первого запуска, реализованная macOS-итерация 0.6.32 и ожидаемый чистый повтор, Base/клоны, границы facade и критерии полного пользовательского результата |
