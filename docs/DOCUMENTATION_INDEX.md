...
| Документ | Назначение |
| --- | --- |
| docs/modules/first-run-onboarding.md | Путь первого запуска, диагностическая 0.6.35 обеих платформ: непрерывный запрос, сетевые этапы, macOS-мастер и ожидаемый T016, Base/клоны, границы facade и критерии полного пользовательского результата |
