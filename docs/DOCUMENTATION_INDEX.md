...
| Документ | Назначение |
| --- | --- |
| docs/modules/first-run-onboarding.md | Путь первого запуска, диагностическая итерация 0.6.33 обеих платформ, macOS-мастер и ожидаемый T014, Base/клоны, границы facade и критерии полного пользовательского результата |
