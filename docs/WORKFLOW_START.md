...
Текущая версия приложения — 0.6.16: «Ваши проекты» использует компактное дерево с newest-first и viewport из трёх сессий; устаревшая плашка «Контекстное окно / Ожидаем данные» полностью удалена вместе с отдельной публикацией contextWindow в sidebar. После принятия и штатного архивирования плана по-прежнему предлагается Chat/Work для новой сессии с актуальным контекстом. Workflow Kit — 1.2.0. Исторические проверки — в `docs/VERIFICATION.md`.
