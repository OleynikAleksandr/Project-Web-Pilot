...
Текущая версия приложения — 0.6.14: после принятия и штатного архивирования плана Web Pilot запрашивает Chat/Work и открывает новую сессию с актуальным контекстом. Переименование, быстрый контекст и спиннеры операций сохранены. Workflow Kit — 1.2.0. Детальные исторические проверки остаются в `docs/VERIFICATION.md` и не являются стартовым контекстом.
