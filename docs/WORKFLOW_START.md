...
Текущая версия приложения — 0.6.7 с Recovery v2, self-healing Runtime Lifecycle и исправленными Chat/Work sessions. Workflow Kit — 1.2.0. Детальные исторические проверки остаются в `docs/VERIFICATION.md` и не являются стартовым контекстом.
