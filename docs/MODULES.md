...
| Release & Local Installation | `docs/RELEASE.md` | Постоянный macOS app, сохранение Finder-алиаса, отдельные ZIP и доставка релиза; проверка установки на чистых ОС — `docs/CLEAN_INSTALL.md` |
