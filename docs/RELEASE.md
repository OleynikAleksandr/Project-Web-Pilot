...
Актуальная поставка — 0.6.40; последний раздел сверки выше относится к действующим ZIP и установленному app. Более ранние версионные разделы сохраняют состояние на момент соответствующего выпуска; ожидавшиеся тогда проверки не заменяют текущий итог в docs/CLEAN_INSTALL.md.
